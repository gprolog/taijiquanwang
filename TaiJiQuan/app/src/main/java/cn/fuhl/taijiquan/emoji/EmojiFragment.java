...
import cn.fuhl.taijiquan.base.BaseFragment;
...
public class EmojiFragment extends BaseFragment implements
		...
		EmojiViewPagerAdapter.OnClickEmojiListener {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		View view = inflater.inflate(R.layout.emoji_fragment, container,
				false);
	...
	public void setButtonMoreClickListener(OnClickListener lis) {
		if (mBtnMore != null)
